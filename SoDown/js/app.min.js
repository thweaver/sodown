...
$(function(){function o(){d=window.innerWidth}function e(){m.scrollTop()>=w.offset().top-300&&f.hasClass("home")&&g.removeClass("nav-item-current")}function n(){m.scrollTop()>=y.offset().top-300&&f.hasClass("home")&&(g.removeClass("nav-item-current"),$("#nav-tour").addClass("nav-item-current"))}function t(){m.scrollTop()>=k.offset().top-300&&f.hasClass("home")&&(g.removeClass("nav-item-current"),$("#nav-music").addClass("nav-item-current"))}function a(){m.scrollTop()>=x.offset().top-300&&f.hasClass("home")&&(g.removeClass("nav-item-current"),$("#nav-shop").addClass("nav-item-current"))}function s(){m.scrollTop()>=T.offset().top-300&&f.hasClass("home")&&(g.removeClass("nav-item-current"),$("#nav-videos").addClass("nav-item-current"))}function i(){m.scrollTop()>=P.offset().top-300&&f.hasClass("home")&&(g.removeClass("nav-item-current"),$("#nav-photos").addClass("nav-item-current"))}function l(){D=m.scrollTop()}function r(){function o(){stopPoint=w.offset().top+w.height()-j,e&&D<stopPoint?(e=!1,$("video").get(0).play(),$("video").prop("muted",!0)):!e&&D>=stopPoint&&(e=!0,$("video").get(0).pause(),$("video").prop("muted",!0))}if(f.hasClass("home")){var e=!1;m.on("scroll resize",o),o()}}function c(){function o(){swapPoint=h.offset().top+h.height()+100-j,e&&D<swapPoint?(e=!1,v.delay(200).removeClass("active-nav")):!e&&D>=swapPoint&&(e=!0,v.delay(200).addClass("active-nav"))}if(f.hasClass("home")){var e=!1;m.on("scroll resize",o),o()}}FastClick.attach(document.body);var d,v=$("html"),m=$(window),f=$("body"),u=$("nav"),h=$(".hero-logo"),p=$(".hamburger"),C=($(".fries"),$(".main-site-logo")),g=($(".if-link"),$(".fb-link"),$(".main-nav-item"));if(m.on("resize load",o),window.matchMedia){var b=window.matchMedia("only screen and (-moz-min-device-pixel-ratio: 1.3), only screen and (-o-min-device-pixel-ratio: 2.6/2), only screen and (-webkit-min-device-pixel-ratio: 1.3), only screen  and (min-device-pixel-ratio: 1.3), only screen and (min-resolution: 1.3dppx)");b&&b.matches&&(document.documentElement.className+=" retina")}m.on("load",function(){v.addClass("loaded")}),p.click(function(o){o.preventDefault(),v.toggleClass("js-nav-enabled")}),g.click(function(o){o.preventDefault(),g.removeClass("nav-item-current"),$(this).addClass("nav-item-current"),m.innerWidth()<800&&v.removeClass("js-nav-enabled")}),C.click(function(o){o.preventDefault(),g.removeClass("nav-item-current")}),$(".venobox").venobox();var w=$("#home"),y=$("#tour"),k=$("#music"),x=$("#shop"),T=$("#videos"),P=$("#photos");$("#bg-1"),$("#bg-2"),$("#bg-3"),$("#bg-5"),$("#bg-6"),$("#bg-4");m.on("scroll load",e),m.on("scroll load",n),m.on("scroll load",t),m.on("scroll load",a),m.on("scroll load",s),m.on("scroll load",i),$(window).ready(function(){$(window).height();$("section").scrollie({scrollOffset:-50,scrollingInView:function(o){var e=o.data("class");$("#background").removeClass(),$("#background").addClass(e)}})});var D,j=u.height();jQuery.fn.exists=function(){return this.length>0},m.on("scroll load",l),m.on("load",r),m.on("load",c),$('a[href^="#"]').on("click",function(o){if(m.innerWidth()>=800&&f.hasClass("home")){var e=$(this.getAttribute("href"));e.length&&(o.preventDefault(),$("html, body").stop().animate({scrollTop:e.offset().top},1e3))}if(m.innerWidth()<800&&f.hasClass("home")){var e=$(this.getAttribute("href"));e.length&&(o.preventDefault(),$("html, body").stop().animate({scrollTop:e.offset().top},0))}}),$(document).ready(function(){$.ajaxSetup({cache:!1}),$(".if-link").click(function(){var o=$(this).attr("href");return $(".video-container").html("content loading"),$(".video-container").load(o),!1})})});